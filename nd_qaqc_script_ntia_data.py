...
tblMergCur = outGDB + os.path.sep + "tbl_temp_merge_cur_wired_wireless"
tblMergPrev = outGDB + os.path.sep + "tbl_temp_merge_prev_wired_wireless"
tblSumMergCur1 = outGDB + os.path.sep + "tbl_temp_sum_merge_cur_wired_wireless_freq"
tblSumMergCur2 = outGDB + os.path.sep + "tbl_temp_sum_merge_cur_wired_wireless_prov"
tblSumMergPrev1 = outGDB + os.path.sep + "tbl_temp_sum_merge_prev_wired_wireless_freq"
tblSumMergPrev2 = outGDB + os.path.sep + "tbl_temp_sum_merge_prev_wired_wireless_prov"
tblMergCurPrev1 = outGDB + os.path.sep + "tbl_temp_merge_cur_prev_wired_wireless_freq"
tblMergCurPrev2 = outGDB + os.path.sep + "tbl_temp_merge_cur_prev_wired_wireless_prov"
tblSumMergCurPrev1 = outGDB + os.path.sep + "tbl_temp_sum_merge_cur_prev_wired_wireless_freq"
tblSumMergCurPrev2 = outGDB + os.path.sep + "tbl_temp_sum_merge_cur_prev_wired_wireless_prov"
tblChgNTIAFeat = outGDB + os.path.sep + "tbl_final_NTIA_change_detection_feat_cnt"
tblChgNTIAFeatProv = outGDB + os.path.sep + "tbl_final_NTIA_change_detection_provider_tot"
tblSumProvTot = outGDB + os.path.sep + "tbl_final_NTIA_summary_provider_transtech"
tblView1 = outGDB + os.path.sep + "tbl_temp_merge_cur_prev_wired_wireless_freq_view"
tblView2 = outGDB + os.path.sep + "tbl_temp_merge_cur_prev_wired_wireless_prov_view"
tblChkGeoFinal = outGDB + os.path.sep + "tbl_final_NTIA_chk_geo"
tblTempIden = outGDB + os.path.sep + "tbl_temp_findIdentical"
tblTempIdenSum = outGDB + os.path.sep + "tbl_temp_findIdentical_sum"
...
for f in fcListCur:
    ...
    arcpy.CopyRows_management ("temp_current_" + f, outGDB + os.path.sep + "tbl_view_current_" + f)
...
for fc in fcListPrev:
    ...
    arcpy.CopyRows_management ("temp_previous_" + fc, outGDB + os.path.sep + "tbl_view_previous_" + fc)
